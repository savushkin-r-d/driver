	...
	void OnPaint( HDC )
	{
		...
		if ( m_bShowThemed && CTheme::IsThemingSupported() )
		{
			...
			TRIVERTEX triVertext[ 2 ] = {
											rcTitleTip.left,
											rcTitleTip.top,
											LOWORD ( GetRValue( m_rgbBackgroundTop ) << 8 ),
											LOWORD ( GetGValue( m_rgbBackgroundTop ) << 8 ),
											LOWORD ( GetBValue( m_rgbBackgroundTop ) << 8 ),
											0x0000,			
											rcTitleTip.right,
											rcTitleTip.bottom,
											LOWORD ( GetRValue( m_rgbBackgroundBottom ) << 8 ),
											LOWORD ( GetGValue( m_rgbBackgroundBottom ) << 8 ),
											LOWORD ( GetBValue( m_rgbBackgroundBottom ) << 8 ),
											0x0000
										};
